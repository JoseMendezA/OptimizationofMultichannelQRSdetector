...
% load('ALPHA_optimo')
load('Performance_PT_EA_Main.mat', 'ALPHA_optimo'); % Calculated at Training

% load('beta_optimo')
load('Performance_PT_EA_Main.mat', 'beta_optimal'); % Calculated at Training 
...
save('Detections_PT_EA_Test','detections');
%% Save multichannel QRS complex detection performance
save('Performance_PT_EA_Test','performance','ALPHA_optimo','beta_optimal');
